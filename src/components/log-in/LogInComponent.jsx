        ...
        <form onSubmit={handleSubmit} className='mx-auto max-[600px]:px-[20px] min-[600px]:w-[500px] flex flex-col gap-7'>
            <div>
                ...
                <input
                    ...
                    className='p-[15px] w-full rounded-md border outline-none focus:border-[#33A0FF]'
                    type="text"
                />
            </div>
            <div>
            ...
            <div>
                {loading ?
                    <button disabled={loading} type="button" className='w-full bg-[#33A0FF] text-white font-[600] py-[20px] px-[40px] rounded-md outline-none'>
                    ...
                    :
                    <button className='w-full bg-[#33A0FF] text-white font-[600] py-[20px] px-[40px] rounded-md outline-none'>Kirish</button>
                }
            </div>
        </form>
    );
